...
pref("spellchecker.dictionaries.download.url", "https://addons.thunderbird.net/en-uS/seamonkey/language-tools/");
...
//  .. etc ..
//
pref("extensions.update.autoUpdateDefault", false); // Download and install automatically
...
pref("extensions.getMoreThemesURL", "https://addons.thunderbird.net/EN-US/seamonkey/complete-themes/");
...
pref("toolkit.mozprotocol.url", "about:");
